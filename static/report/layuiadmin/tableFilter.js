			...
			layui.each(filters, function(i, filter){
				...
				filterIcon.on("click", function(e) {
					...
					if(filterType == "checkbox"){
						...
						filterBox.find('form').append('<input placeholder="关键词" class="layui-input "+"'+filterName+'" oninput="table_field_filter(this)">');
						if(!filterUrl){
							var sort_filterdata = filterData.sort(compare('value'));
							layui.each(sort_filterdata, function(i, item){
